...
" Sup bish, ",
" Yo momma so fat, ",
" You are such a loser, that ",
" STFU, ",
" Yo bitchass, ",
" The only thing dumber than you is ",
" Kiss my ass you ",
" You look worse than ",
" How about you go ",
" Can you not ",
" Why don&rsquo;t you just ",
" After you&rsquo;re done playing in traffic, ",
" Lose my number and ",
...
function changeinsult() {
	var random_insult_number = Math.floor(Math.random() * insults.length);
	insults_to_use = insults[random_insult_number],
	result = '<span class="insults">' + insults_to_use + '</span>';
	characterCount = characterCount - insultCharCount + parseInt(insults_to_use.length -1);
	insultCharCount = parseInt(insults_to_use.length -1);
...
function generateCard() {
	...
	var random_putdown_number = Math.floor(Math.random() * putdowns.length );
	putdowns_to_use = putdowns[random_putdown_number],
	result = '<span class="putdown">' + putdowns_to_use + '</span>';
...
$('.send').click(function() {
	...
	myTweet = myTweet.replace('  ', '');
	myTweet = myTweet.replace(/<span class="putdown">/g, '');
	myTweet = myTweet.replace(/<\/span>/g, '');
	myTweet = myTweet.replace(/<span class="insults">/g, '');
	myTweet = myTweet.replace(/\n/g, '');
